...
namespace AuroraServerClient.Custom
{
    public class CircularPB : Control
    {
        ...
        #endregion
        #region CircularPB
        string programJsonFile = "http://fivemsunucum.com/aurora/program.json";
        ProgramModel model;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            #region DrawString
            if (!allowText) return;
            string text = (value * model.MaxClient / maxValue).ToString("0") + " / " + model.MaxClient;
            Size textSize;
            float ratio = 1.0f;
